...
from src.api.routers.device_service_network_routes import (
    router as device_service_network_router,
)
...
def list_device_tags(
    ...
    tags = tag_service.get_by_device(device_id, session, owner_id=_owner_id(request))
...
def attach_tag_to_device(
    ...
    tag_service.attach_to_device(device_id, data.tag_id, session, owner_id=_owner_id(request))
...
def detach_tag_from_device(
    ...
    tag_service.detach_from_device(device_id, tag_id, session, owner_id=_owner_id(request))
...
def list_device_custom_fields(
    ...
    cfs = custom_field_service.get_by_device(
        device_id,
        session,
...
def create_device_custom_field(
    ...
    cf = custom_field_service.create(
        device_id,
        data,
        session,
        owner_id=_owner_id(request),
...
def update_device_custom_field(
    ...
    cf = custom_field_service.update(
        device_id,
        cf_id,
        data,
        session,
...
def delete_device_custom_field(
    ...
    custom_field_service.delete(device_id, cf_id, session, owner_id=_owner_id(request))
...
def list_device_connections(
    ...
    conns = connection_service.get_connections_for_device(
        device_id,
        session,
        owner_id=_owner_id(request),
    )
...
def canvas_delete_device(
    ...
    return canvas_undo_service.delete_published_device_for_canvas(
        device_id,
        session,
        owner_id=_owner_id(request),
    )
...
def restore_canvas_deleted_device(
    ...
    return canvas_undo_service.restore_published_device_for_canvas(
        data,
        session,
        owner_id=_owner_id(request),
    )
...
router.include_router(device_service_network_router)
