...
async def settings_profile_page() -> None:
    ...
    with app_shell("Profile", "/settings/profile", breadcrumb=["Settings", "Profile"]):
        ...
        ui.button("Update Password", on_click=_submit).props("unelevated").style(
            "background: var(--ht-accent); color: var(--ht-text-on-accent); width: 100%; margin-top: 8px;"
        )
