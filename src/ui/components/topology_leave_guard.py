...
(function(){
  ...
  function ensureModal(){
    ...
    root.style.cssText = 'position:fixed;inset:0;display:none;align-items:center;justify-content:center;z-index:100001;background:color-mix(in srgb,var(--ht-bg-base) 74%,transparent);';
    card.style.cssText = 'width:min(540px,92vw);background:var(--ht-bg-surface);color:var(--ht-text-primary);border:1px solid var(--ht-border);border-radius:12px;padding:18px 18px 16px;box-shadow:var(--ht-shadow-lg);';
    ...
    body.style.cssText = 'margin:0 0 14px;color:var(--ht-text-secondary);font-size:0.92rem;';
    ...
    cancelBtn.style.cssText = 'padding:8px 12px;border:1px solid var(--ht-border);border-radius:8px;cursor:pointer;font-weight:600;background:transparent;color:var(--ht-text-primary);';
    discardBtn.textContent = 'Discard'; discardBtn.type = 'button';
    discardBtn.style.cssText = 'padding:8px 12px;border:1px solid color-mix(in srgb,var(--ht-error) 35%,var(--ht-border));border-radius:8px;cursor:pointer;font-weight:600;background:color-mix(in srgb,var(--ht-error) 15%,transparent);color:var(--ht-error);';
    saveBtn.textContent = 'Save Version'; saveBtn.type = 'button';
    saveBtn.style.cssText = 'padding:8px 12px;border:none;border-radius:8px;cursor:pointer;font-weight:600;background:var(--ht-accent);color:var(--ht-text-on-accent);';
