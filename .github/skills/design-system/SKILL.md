...
Use these heuristics when deciding whether a component is merely styled correctly or actually usable.
...
- Preserve summary-first flow; avoid replacing the canvas with full-page detail states
...
- Avoid showing every detail column at once; dense metadata belongs in secondary surfaces
