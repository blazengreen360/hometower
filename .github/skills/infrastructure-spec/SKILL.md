...
Use these rules when changing Docker, env vars, build images, or deployment docs.
...
- `docker compose config` should compile cleanly
- `docker compose build` should succeed without drift surprises
- service health checks should remain meaningful after the change
